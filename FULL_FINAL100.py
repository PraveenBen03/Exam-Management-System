...
mydb=mysql.connector.connect(host="localhost",user="root",port='3306', passwd="toor")
...
mydb=mysql.connector.connect(host="localhost",user="root",port='3306', passwd="toor",database="edms")
mycursor=mydb.cursor()
